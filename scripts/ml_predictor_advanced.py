...
def predict(self):
    ...
    Menggunakan cache jika ada.
    """
    # Cek cache terlebih dahulu
    from scripts.cache_manager import load_prediction_cache
    cached = load_prediction_cache(self.symbol)
    ...
    from scripts.cache_manager import save_prediction_cache
    save_prediction_cache(self.symbol, direction, confidence)
